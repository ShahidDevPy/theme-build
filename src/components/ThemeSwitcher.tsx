        ...
        <section className='bg-baseThree px-5 py-4 absolute lg:right-36 sm:right-12 right-4 top-24'>
            <div className='grid sm:grid-cols-3 grid-cols-1 gap-10'>
                {themes.map((theme, index) => (
                    <div
                        className={`max-w-[150px] p-1 ${selectedTheme === theme.name && 'border-2 border-green-500 rounded-md'}`}
                        key={index}>
                        <label>
                            <input
                                type='radio'
                            ...
                            <div className='flex items-center justify-between mt-2'>
                                ...
                                <div
                                    className='bg-green-500 rounded-full w-[20px] flex items-center justify-center text-white text-sm'>{selectedTheme === theme.name &&
                                    <span>&#10003;</span>}</div>
                            </div>
                        </label>
                    </div>
